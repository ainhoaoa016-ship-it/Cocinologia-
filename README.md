...
const CATEGORIES = ["Todos", "Italiana", "Asiática", "Española", "Griega", "Británica", "Alemana", "Postres"];
...
const RECIPES_DATA = [
  { 
    ...
    steps: [
      ...
      "Añade los piñones y sigue triturando.",
      "Incorpora la albahaca poco a poco con movimientos circulares.",
      "Añade el queso y finalmente el aceite en hilo hasta que emulsione.",
      "Cuece la pasta 'al dente' y mézclala con el pesto en frío añadiendo un poco de agua de cocción."
    ],
    description: "El aroma de la albahaca fresca machacada es la esencia de Liguria. Un plato rápido pero lleno de técnica tradicional." 
  },
  { 
    id: 2, 
    ...
    steps: [
      "Dora el guanciale en una sartén grande sin aceite extra hasta que esté crujiente.",
      "Añade el peperoncino y desglasa con el vino blanco. Deja evaporar.",
      "Retira el guanciale y reserva. Añade los tomates a la misma sartén y rompe con una cuchara.",
      "Cocina la salsa a fuego lento durante 15 minutos.",
      "Cuece los rigatoni y añádelos a la salsa con el guanciale reservado.",
      "Apaga el fuego, añade el queso pecorino y mezcla enérgicamente."
    ],
    description: "Un plato rústico y potente originario de Amatrice. La clave está en el guanciale y el pecorino." 
  },
  { 
    id: 4, 
    ...
    ingredients: [
      ...
      "1 Pepino pequeño en láminas",
      "Cacahuetes picados"
    ],
    steps: [
      "Cocina la panceta al horno o a la plancha hasta que esté muy tierna y la piel crujiente.",
      "Calienta los panes bao al vapor durante 3-5 minutos hasta que estén esponjosos.",
      "Unta el interior del bao con una cucharada de salsa hoisin.",
      "Coloca una pieza de panceta, unas láminas de pepino y la cebolleta picada.",
      "Termina con un toque de cacahuete picado para dar textura."
    ],
    description: "Esponjosos bocadillos al vapor que se deshacen en la boca. Un hit del street food asiático." 
  },
  { 
    id: 6, 
    title: "Takoyaki", 
    ...
    ingredients: [
      ...
      "450ml de Caldo Dashi frío",
      "2 Huevos",
      "10g de Jengibre encurtido picado",
      "Salsa Takoyaki y Mayonesa japonesa"
    ],
    steps: [
      "Mezcla la harina, los huevos y el caldo dashi hasta tener una masa líquida y sin grumos.",
      "Calienta el molde de Takoyaki y engrasa bien cada hueco.",
      "Vierte la masa hasta llenar los huecos y añade un trozo de pulpo y jengibre en cada uno.",
      "Cuando los bordes estén cocidos, gira las bolitas 90 grados con un palillo.",
  ...
  { 
    ...
    steps: [
      ...
      "Fríe las patatas en abundante aceite a fuego medio para que se confiten y luego sube el fuego para dorarlas.",
      "Escurre las patatas y ponlas en un plato con un poco de sal.",
      "Fríe los huevos en el mismo aceite muy caliente para que salga 'puntilla' pero la yema quede líquida.",
      "Coloca los huevos sobre las patatas y el jamón por encima.",
      "Rompe los huevos con un cuchillo y tenedor justo antes de comer."
    ],
    description: "La yema líquida bañando las patatas fritas es un manjar universal. La calidad del jamón es clave." 
  },
  { 
    id: 9, 
    ...
    ingredients: [
      ...
      "100g de Jamón en tacos",
      "1 cucharada de Pimentón de la Vera",
      "Cebolla, Laurel y Guindilla"
    ],
    steps: [
      "Lava bien los callos con agua y vinagre. Ponlos a cocer con cebolla, laurel y sal durante 2-3 horas hasta que estén tiernos.",
      "En una cazuela aparte, haz un sofrito con cebolla picada, el jamón y el pimentón (cuidado que no se queme).",
      "Añade los callos cocidos al sofrito con un poco de su caldo de cocción.",
      "Incorpora el chorizo y la morcilla enteros. Cocina a fuego lento 30 minutos.",
      "Saca el embutido, trocéalo y vuelve a añadirlo. Deja reposar (están mejor al día siguiente)."
    ],
    description: "Un guiso tradicional, meloso y con un toque picante inconfundible. Esencial para los días de frío." 
  }
];
...
const BLOG_POSTS = [
  {
    ...
    content: "Europa es un mosaico de culturas vivas. Basado en las guías de la UE, este viaje se centra en la libertad de movimiento y la riqueza gastronómica.",
  ...
  },
  {
    ...
    content: "Tal como indica la guía Abreu 2025-26, Italia sigue siendo el destino estrella. En Roma, el Coliseo te transporta al imperio.",
...
const App = () => {
  ...
  const handleChefChat = async () => {
    ...
    const system = "Eres el Chef Ainhoa, una chef joven de 18 años. Responde de forma juvenil y profesional.";
    try {
      const res = await callGemini(chatInput, system);
      setChefResponse(res);
      setChatInput("");
    } catch (e) {
      setChefResponse("¡Uy! Hubo un problema. Inténtalo de nuevo.");
    } finally {
  ...
  const generateItinerary = async (country) => {
    setGeminiLoading(true);
    const prompt = `Crea un itinerario gourmet de 3 días para ${country}. Responde en español con formato Markdown.`;
    try {
        ...
        <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in duration-500 pb-20 px-4">
          ...
          <div className="bg-white p-10 rounded-[4rem] shadow-xl space-y-10 border-2 border-sky-50">
            <div className="space-y-6">
              <h2 className="text-3xl font-serif font-black text-slate-800">Mi Guía Europa 2025</h2>
              ...
              >
                {geminiLoading ? '...' : <Sparkles size={18} />} ✨ Generar Itinerario
              </button>
            </div>
          </div>
        </div>
            ...
            <div className="relative h-[650px] rounded-[4rem] overflow-hidden shadow-2xl border-[12px] border-white group">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/70 to-transparent flex flex-col justify-end p-16">
                <div className="bg-white/95 backdrop-blur-xl p-12 rounded-[4rem] w-fit shadow-2xl">
                  <h1 className="text-6xl md:text-7xl font-serif font-black text-sky-600 mb-2 tracking-tighter">Cocinología</h1>
            ...
            <section className="bg-white rounded-[4rem] p-12 shadow-2xl shadow-sky-100 border-4 border-sky-50 flex flex-col md:flex-row items-center gap-14">
              ...
              <div className="space-y-8 text-center md:text-left">
                ...
                <p className="text-slate-600 leading-relaxed text-2xl max-w-2xl font-bold">
                  Soy una apasionada de los viajes y la buena mesa. Aquí tienes mi rincón de **Cocinología**.
                </p>
                <div className="bg-sky-50 p-8 rounded-[3rem] border-2 border-sky-100 space-y-6 max-w-xl">
                    <p className="text-sky-700 font-black text-sm uppercase flex items-center gap-2">
                        <Sparkles size={20} className="text-sky-400" /> Pregúntale a Chef Ainhoa
                    </p>
                    <div className="flex gap-3">
                        <input type="text" className="flex-1 bg-white px-6 py-3 rounded-2xl border border-sky-100 outline-none text-slate-800 font-bold" placeholder="¿Cómo sustituyo el guanciale?" value={chatInput} onChange={(e) => setChatInput(e.target.value)} onKeyDown={(e) => e.key === 'Enter' && handleChefChat()} />
            ...
            <div className="bg-white p-16 rounded-[5rem] shadow-2xl border-[16px] border-sky-50 text-center space-y-12">
              ...
              {!isScanning && !scanResult && (
                <div onClick={() => document.getElementById('fileInput').click()} className="border-8 border-dashed border-sky-100 rounded-[4rem] p-24 hover:bg-sky-50 transition-all cursor-pointer group relative overflow-hidden">
                  ...
                  <p className="font-black text-sky-500 uppercase tracking-[0.4em] text-sm">✨ Escanear Plato</p>
              ...
              {scanResult && (
                <div className="text-left space-y-10">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    {[
                      { l: 'Calorías', v: scanResult.calories, c: 'bg-sky-50 text-sky-800' }, 
                      { l: 'Proteína', v: scanResult.protein, c: 'bg-blue-50 text-blue-800' }, 
      ...
      case 'blog':
        return (
          <div className="max-w-6xl mx-auto space-y-24 animate-in fade-in duration-700 px-4">
            <div className="text-center space-y-6">
              <h2 className="text-7xl font-serif font-black text-slate-800 tracking-tighter">Guía Europa 2025 🌍</h2>
            </div>
              ...
              {BLOG_POSTS.map(post => (
                <article key={post.id} onClick={() => setSelectedTravel(post)} className="bg-white rounded-[5rem] overflow-hidden shadow-2xl border-8 border-white group cursor-pointer hover:-translate-y-6 transition-all">
                  <div className="h-[450px] overflow-hidden relative">
                    ...
                    <div className="absolute bottom-10 left-10 text-white">
                      <p className="text-xs font-black uppercase tracking-[0.4em] mb-2 opacity-80">📍 {post.city}</p>
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-800 font-sans pb-48">
      <nav className="sticky top-0 z-40 bg-white/95 backdrop-blur-2xl border-b-[10px] border-sky-50 px-6 md:px-12 py-8">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-5 cursor-pointer group" onClick={() => { setActiveTab('home'); setSelectedTravel(null); }}>
            ...
            <span className="text-3xl md:text-5xl font-serif font-black tracking-tighter text-sky-600 italic">Cocinología</span>
          </div>
          <div className="hidden lg:flex items-center gap-14">
            {[{ id: 'home', l: 'Inicio' }, { id: 'recipes', l: 'Recetario' }, { id: 'scan', l: 'Scan IA' }, { id: 'blog', l: 'Guía Europa' }].map(tab => (
              ...
              {transformation ? (
                <div className="space-y-6 animate-in slide-in-from-right-4">
                    <div className="flex justify-between items-center">
                        <h3 className="text-3xl font-serif font-black text-sky-600">Versión {transformation.type}</h3>
                ...
                <>
                    ...
                    <div className="flex gap-10 border-y-4 border-sky-50 py-8">
                        {[{ l: 'Tiempo', v: selectedRecipe.time }, { l: 'Nivel', v: selectedRecipe.difficulty }, { l: 'Energía', v: selectedRecipe.calories }].map((stat, i) => (
      ...
      <footer className="max-w-7xl mx-auto px-12 mt-40 text-center space-y-16 pb-32">
        ...
        <div className="space-y-6"><h3 className="text-6xl font-serif font-black italic text-sky-600 tracking-tighter">Cocinología</h3><p className="text-slate-400 font-black uppercase tracking-[0.5em] text-xs">Ainhoa • 2026</p></div>
        <p className="text-slate-300 text-[10px] font-black tracking-[0.6em] uppercase">© Cocinología - Potenciado por ✨ Gemini 2.5 AI</p>
      </footer>
    </div>
  );
};
